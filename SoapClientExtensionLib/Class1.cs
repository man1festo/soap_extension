...
using System.Windows.Forms;
    ...
    public class ClientExtension : SoapExtension
    {
        Stream appStream;
        Stream wireStream;
        private string soap;
        ...
        public override void ProcessMessage(SoapMessage message)
        {
            switch (message.Stage)
            {
                ...
                case SoapMessageStage.AfterSerialize:
                    ...
                    //Copy(originalStream, workingStream);
                    WriteOutput(message.Stream);
                    break;
        ...
        public void WriteOutput(Stream message)
        {
            ...
            MessageBox.Show("Сообщение клиента:" + soap);
            encryptedMsg = Encrypt(soap, "Passpord11", "Password22", "SHA1", 2,
                                                 "16CHARSLONG12345", 256);
            MessageBox.Show("Шифр клиента:" + encryptedMsg);
        ...
        public void RecInput(SoapMessage message)
        {
            ...
            soap = ResultNode.InnerXml;
            MessageBox.Show("Получен зашифрованный ответ от сервера:" + soap);
            decryptedMsg = Decrypt(soap, "Passpord11", "Password22", "SHA1", 2,
                                                 "16CHARSLONG12345", 256);
            MessageBox.Show("Полученный ответ сервера после расшифровки:" + decryptedMsg);
